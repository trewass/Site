          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              ...
              <div className="group cursor-pointer">
                ...
                <h3 className="font-semibold text-neutral-900 mb-1">Кухня в Ялте</h3>
              ...
              <div className="group cursor-pointer">
                ...
                <h3 className="font-semibold text-neutral-900 mb-1">Гардероб в Сочи</h3>
              ...
              <div className="group cursor-pointer">
                ...
                <h3 className="font-semibold text-neutral-900 mb-1">Ванная в Краснодаре</h3>
