...
export default function WardrobeCase2() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="container-custom py-6">
        <nav className="flex items-center space-x-2 text-sm text-neutral-500">
          ...
          <span>→</span>
          <span className="text-neutral-900">Гардеробная система премиум-класса</span>
        </nav>
      </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h1 className="heading-xl mb-6">
              Гардеробная система премиум-класса
            </h1>
      ...
      <section className="py-12">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-3 text-body text-neutral-600">
                  <li className="flex items-start">
                    ...
                    Каркас из ЛДСП толщиной 18мм
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Фасады из МДФ с шпонированием
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              ...
              <div>
                ...
                <ul className="space-y-3 text-body text-neutral-600">
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Штанги для одежды из нержавеющей стали
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Система освещения с датчиками движения
                  </li>
                </ul>
              </div>
            </div>
            ...
            {/* Цветовые решения */}
            <div className="mt-8">
              <h3 className="heading-md mb-4">Цветовые решения</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-neutral-50 rounded-xl p-6">
                  <div className="text-caption text-neutral-500 mb-2">Фасады</div>
                  <div className="font-semibold">Шпон дуба светлый</div>
                </div>
                <div className="bg-neutral-50 rounded-xl p-6">
                  <div className="text-caption text-neutral-500 mb-2">Внутренние элементы</div>
                  <div className="font-semibold">Белый матовый</div>
                </div>
                <div className="bg-neutral-50 rounded-xl p-6">
                  <div className="text-caption text-neutral-500 mb-2">Фурнитура</div>
                  <div className="font-semibold">Хром</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              <Link href="/projects/kitchen-modern-1" className="btn-secondary mb-4 sm:mb-0">
                ← Предыдущий проект
              </Link>
              <Link href="/raboty" className="btn-secondary">
                Назад к галерее
              </Link>
              <Link href="/projects/bathroom-furniture-3" className="btn-secondary">
                Следующий проект →
              </Link>
            </div>
          </div>
