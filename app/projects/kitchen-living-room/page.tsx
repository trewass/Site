...
export default function KitchenLivingRoom() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="container-custom py-6">
        <nav className="flex items-center space-x-2 text-sm text-neutral-500">
          ...
          <span>→</span>
          <span className="text-neutral-900">Кухня-гостиная в Краснодаре</span>
        </nav>
      </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
              <div className="bg-neutral-50 rounded-xl p-6">
                ...
                <div className="font-semibold">Кухня-гостиная</div>
              </div>
              <div className="bg-neutral-50 rounded-xl p-6">
                <div className="text-caption text-neutral-500 mb-1">Площадь</div>
                <div className="font-semibold">18 м²</div>
              </div>
              <div className="bg-neutral-50 rounded-xl p-6">
                <div className="text-caption text-neutral-500 mb-1">Сроки</div>
                <div className="font-semibold">50 дней</div>
              </div>
              <div className="bg-neutral-50 rounded-xl p-6">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-neutral-50 rounded-xl p-6">
                  ...
                  <div className="font-semibold">Серый матовый</div>
                </div>
                <div className="bg-neutral-50 rounded-xl p-6">
                  <div className="text-caption text-neutral-500 mb-2">Столешница</div>
                  <div className="font-semibold">Белый кварц</div>
                </div>
                <div className="bg-neutral-50 rounded-xl p-6">
                  <div className="text-caption text-neutral-500 mb-2">Барная стойка</div>
                  <div className="font-semibold">Дерево дуб</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              ...
              <Link href="/projects/wardrobe-case-2" className="btn-secondary">
                Следующий проект →
              </Link>
            </div>
          </div>
