...
export default function WardrobeBedroom() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="container-custom py-6">
        <nav className="flex items-center space-x-2 text-sm text-neutral-500">
          ...
          <span>→</span>
          <span className="text-neutral-900">Шкаф-купе в спальне</span>
        </nav>
      </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
              <div className="bg-neutral-50 rounded-xl p-6">
                ...
                <div className="font-semibold">Шкаф-купе</div>
              </div>
              <div className="bg-neutral-50 rounded-xl p-6">
                <div className="text-caption text-neutral-500 mb-1">Площадь</div>
                <div className="font-semibold">4 м²</div>
              </div>
              <div className="bg-neutral-50 rounded-xl p-6">
              ...
              <div className="bg-neutral-50 rounded-xl p-6">
                ...
                <div className="font-semibold">МДФ, зеркало</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-3 text-body text-neutral-600">
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Зеркальные двери с алюминиевым профилем
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-neutral-50 rounded-xl p-6">
                  <div className="text-caption text-neutral-500 mb-2">Двери</div>
                  <div className="font-semibold">Зеркало</div>
                </div>
                <div className="bg-neutral-50 rounded-xl p-6">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              <Link href="/projects/kitchen-living-room" className="btn-secondary mb-4 sm:mb-0">
                ← Предыдущий проект
              </Link>
