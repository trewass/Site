...
export default function KitchenModern1() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="container-custom py-6">
        <nav className="flex items-center space-x-2 text-sm text-neutral-500">
          ...
          <span>→</span>
          <span className="text-neutral-900">Кухня для семьи в современном стиле</span>
        </nav>
      </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h1 className="heading-xl mb-6">
              Кухня для семьи в современном стиле
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-3 text-body text-neutral-600">
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Фасады из МДФ с пластиковым покрытием
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-neutral-400 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Система плавного закрывания Blum
                  </li>
                </ul>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-neutral-50 rounded-xl p-6">
                  <div className="text-caption text-neutral-500 mb-2">Столешница</div>
                  <div className="font-semibold">Серый кварц</div>
                </div>
                <div className="bg-neutral-50 rounded-xl p-6">
                  <div className="text-caption text-neutral-500 mb-2">Фартук</div>
                  <div className="font-semibold">Белый керамогранит</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              <Link href="/projects/wardrobe-case-2" className="btn-secondary mb-4 sm:mb-0">
                ← Предыдущий проект
              </Link>
