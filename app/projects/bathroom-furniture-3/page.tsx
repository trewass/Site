...
export default function BathroomFurniture3() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="container-custom py-6">
        <nav className="flex items-center space-x-2 text-sm text-neutral-500">
          ...
          <span>→</span>
          <span className="text-neutral-900">Мебель для ванной комнаты</span>
        </nav>
      </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
              <div className="bg-neutral-50 rounded-xl p-6">
                ...
                <div className="font-semibold">Ванная комната</div>
              </div>
              <div className="bg-neutral-50 rounded-xl p-6">
                <div className="text-caption text-neutral-500 mb-1">Площадь</div>
                <div className="font-semibold">6 м²</div>
              </div>
              <div className="bg-neutral-50 rounded-xl p-6">
                <div className="text-caption text-neutral-500 mb-1">Сроки</div>
                <div className="font-semibold">25 дней</div>
              </div>
              <div className="bg-neutral-50 rounded-xl p-6">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-neutral-50 rounded-xl p-6">
                  ...
                  <div className="font-semibold">Белый глянцевый</div>
                </div>
                <div className="bg-neutral-50 rounded-xl p-6">
